...
The `mpay` Rust library provides an intuitive interface over the Machine Payments Protocol, from high-level abstractions to low-level primitives and building blocks.
