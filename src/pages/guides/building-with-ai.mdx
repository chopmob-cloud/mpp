...
Copy this URL and paste it into your agent (Claude Code, Cursor, Amp, or similar):
...
Add mpay to my Next.js app with a /api/checkout route.
```
...
After installing, your agent knows how to integrate `mpay` with your chosen framework.
