...
### <div className="vocs:mr-2"><Badge variant="info">Agent</Badge></div> Call a tool
...
### <div className="vocs:mr-2"><Badge variant="warning">Server</Badge></div> Return payment challenge
...
### <div className="vocs:mr-2"><Badge variant="info">Agent</Badge></div> Retry with credential
...
### <div className="vocs:mr-2"><Badge variant="warning">Server</Badge></div> Return result with receipt
