...
### <div className="vocs:mr-2"><Badge variant="info">Client</Badge></div> Request a resource
...
### <div className="vocs:mr-2"><Badge variant="warning">Server</Badge></div> Send a payment challenge
...
### <div className="vocs:mr-2"><Badge variant="info">Client</Badge></div> Retry with a credential
...
### <div className="vocs:mr-2"><Badge variant="warning">Server</Badge></div> Return a receipt
