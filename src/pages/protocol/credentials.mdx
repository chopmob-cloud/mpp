...
A **Credential** is the client's response to a [Challenge](/protocol/challenges), proving that you paid or authorized the payment. Credentials are sent in the `Authorization` header.
...
<Cards>
  <Card
    description="Normative credential format"
    icon="lucide:file-text"
    title="Specification"
    to="https://paymentauth.tempo.xyz/draft-httpauth-payment-00#name-credentials-authorization"
  />
  <Card
    description="Method-specific payload schemas"
    icon="lucide:credit-card"
    title="Payment Methods"
    to="https://paymentauth.tempo.xyz/methods"
  />
</Cards>
