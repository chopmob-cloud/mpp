...
A server issues a **challenge** to describe the payment required for a resource. Challenges are sent in the `WWW-Authenticate` header using the Payment authentication scheme.
...
<Cards>
  <Card
    description="Normative challenge format"
    icon="lucide:file-text"
    title="Specification"
    to="https://paymentauth.tempo.xyz/draft-httpauth-payment-00#name-challenge-www-authenticate"
  />
  <Card
